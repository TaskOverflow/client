...
app.config(
    ['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider
        // Home
        .when("/", {templateUrl: "views/question.html", controller: "QuestionCtrl"})
        // Pages
        .when("/question", {templateUrl: "views/question.html", controller: "QuestionCtrl"})
        .when("/tag", {templateUrl: "views/tag.html", controller: "TagCtrl"})
        .when("/user", {templateUrl: "views/user.html", controller: "UserCtrl"})
        .when("/badge", {templateUrl: "views/badge.html", controller: "BadgeCtrl"})
        // else 404
        .when("/error", {templateUrl: "views/error.html", controller: "ErrorCtrl"})
        .otherwise({templateUrl: "views/error.html", controller: "ErrorCtrl"});
